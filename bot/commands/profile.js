...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const how = `Как получать и зарабатывать очки репутации:\n` +
      ...
      `Данные хранятся локально в базе ` + '`db.json`' + ` и собираются автоматически: тикеты при создании обращения, сообщения ИИ сохраняются в памяти бота (если вы не отключили сохранение через /aiprivacy).`;
